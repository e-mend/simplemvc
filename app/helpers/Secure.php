...
class Secure
{
    ...
    private const REGEX = [
        ...
        'pin' => "/^[0-9]{6}$/",
        'text' => "/^[a-zA-Z0-9áéíóúãõâêîôûàèìòùäëïöüççñÁÉÍãÓÚÃÕÂÊÎÔÛÀÈÌÒÙÄËÏÖÜÇÑ@._%+\-\s\,\(\)\-\:]{1,32}$/",
        'hex' => "/^[a-f0-9]{64}$/",
        ...
        'quantity' => "/^[0-9]{1,20}$/",
        'price' => "/^[0-9]{1,20}$/",
        'description' => "/^[a-zA-Z0-9áéíóúãõâêîôûàèìòùäëïöüççñÁÉÍãÓÚÃÕÂÊÎÔÛÀÈÌÒÙÄËÏÖÜÇÑ@._%+\-\s\,\(\)\-\:]{1,1000}$/",
    ];
